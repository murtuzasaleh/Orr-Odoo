...
class website_account(website_account):
    ...
    def workorder_submitted(self, **post):
        ...
        project_id = (
            ...
            .sudo()
            .search([("custom_code", "=", post.get("project_code"))], limit=1)
        )
        if project_id:
            vale.update(
        ...
        issue_template = http.request.env.ref(
            "job_workorder_website_request.email_template_job_order"
        )
    ...
    def my_joborders(
        ...
        return request.render(
            "job_workorder_website_request.my_portal_job_order", values
        )
