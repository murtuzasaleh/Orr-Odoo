...
class CustomerPortal(CustomerPortal):
    ...
    @http.route(
        ["/my/subcontractors", "/my/subcontractors/page/<int:page>"],
        type="http",
        auth="user",
        website=True,
    )
    def portal_my_subcontractors(
        self,
        page=1,
        date_begin=None,
        date_end=None,
        ...
        **kw
        ...
        if search and search_in:
            ...
            if search_in in ("customer", "all"):
                search_domain = OR(
                    [search_domain, [("custom_partner_id", "ilike", search)]]
                )
        ...
        return request.render(
            "job_order_subcontracting.portal_my_subcontractors", values
        )
    ...
    @http.route(
        ["/my/subcontractor/<int:task_id>"], type="http", auth="user", website=True
    )
