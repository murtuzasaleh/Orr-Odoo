...
class ProjectTask(models.Model):
    ...
    def create(self, vals):
        ...
        if result.project_id.analytic_tag_ids:
            result.write({'accounting_tag':
                          [(6, 0, result.project_id.analytic_tag_ids.ids)]})
        return result
    ...
    accounting_tag = fields.\
        Many2many('account.analytic.tag', name='Analytic Tag', readonly=True)
