...
class CrossoveredBudgetLines(models.Model):
    ...
    percentage_stored = fields.Float(
        compute="_compute_percentage_store", string="Achievement"
    )
    company_id = fields.Many2one(
    ...
    def _compute_percentage(self):
        for line in self:
            if line.theoritical_amount != 0.00:
                line.percentage = (
                    float((line.practical_amount or 0.0) / line.theoritical_amount)
                    * 100
                )
            else:
