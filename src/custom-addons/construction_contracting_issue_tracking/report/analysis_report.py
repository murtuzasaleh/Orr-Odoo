...
class ConstructionReport(models.Model):
    ...
    team_id = fields.Many2one("construction.team", string="Issue Team",)
    ...
    type_ticket_id = fields.Many2one(
        "construction.ticket.type", string="Type of Issue",
    )
    subject_type_id = fields.Many2one(
        "construction.type.of.subject", string="Type of Subject",
    )
    stage_id = fields.Many2one("construction.stage.config", string="stage",)
    remaining_hours = fields.Float(string="Remaining Hours",)
    total_purchase_hours = fields.Float(string="Total Purchase Hours",)
    total_consumed_hours = fields.Float(string="Total Consumed Hours",)
    planned_revenue = fields.Float("Expected Revenue",)
    total_spend_hours = fields.Float(string="Total Hours Spent",)
