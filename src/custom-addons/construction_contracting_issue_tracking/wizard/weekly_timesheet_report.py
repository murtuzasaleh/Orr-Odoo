...
class WeeklyTimesheetReport(models.TransientModel):
    ...
    start_date = fields.Date("Start Date", required=True, default=start_date,)
    end_date = fields.Date("End Date", required=True, default=end_date,)
    ...
    def weekly_time_sheet_report(self):
        ...
        return self.env["report"].get_action(
            self, "construction_contracting_issue_tracking.report_weekly", data=data
        )
