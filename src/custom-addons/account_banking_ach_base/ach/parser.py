...
class Parser(object):
    ...
    FILE_HEADER_DEF = [
        ...
        {"field": "priority_code", "pos": 1, "len": 2,},
        {"field": "immediate_dest", "pos": 3, "len": 10,},
        {"field": "immediate_org", "pos": 13, "len": 10,},
        {"field": "file_crt_date", "pos": 23, "len": 6,},
        {"field": "file_crt_time", "pos": 29, "len": 4,},
        {"field": "file_id_mod", "pos": 33, "len": 1,},
        {"field": "record_size", "pos": 34, "len": 3,},
        {"field": "blk_factor", "pos": 37, "len": 2,},
        {"field": "format_code", "pos": 39, "len": 1,},
        {"field": "im_dest_name ", "pos": 40, "len": 23,},
        {"field": "im_orgn_name ", "pos": 63, "len": 23,},
        {"field": "reference_code", "pos": 86, "len": 8,},
    ]

    FILE_CONTROL_DEF = [
        {"field": "record_type_code", "pos": 0, "len": 1,},
        {"field": "batch_count", "pos": 1, "len": 6,},
        {"field": "block_count", "pos": 7, "len": 6,},
        {"field": "entadd_count", "pos": 13, "len": 8,},
        {"field": "entry_hash", "pos": 21, "len": 10,},
        {"field": "debit_amount", "pos": 31, "len": 12,},
        {"field": "credit_amount", "pos": 43, "len": 12,},
        {"field": "reserved", "pos": 55, "len": 39,},
    ]

    BATCH_HEADER_DEF = [
        {"field": "record_type_code", "pos": 0, "len": 1,},
        {"field": "serv_cls_code", "pos": 1, "len": 3,},
        {"field": "company_name", "pos": 4, "len": 16,},
        {"field": "cmpy_dis_data", "pos": 20, "len": 20,},
        {"field": "company_id", "pos": 40, "len": 10,},
        {"field": "std_ent_cls_code", "pos": 50, "len": 3,},
        {"field": "entry_desc", "pos": 53, "len": 10,},
        {"field": "desc_date", "pos": 63, "len": 6,},
    ...
    BATCH_CONTROL_DEF = [
        {"field": "record_type_code", "pos": 0, "len": 1,},
        {"field": "serv_cls_code", "pos": 1, "len": 3,},
        {"field": "entadd_count", "pos": 4, "len": 6,},
        {"field": "entry_hash", "pos": 10, "len": 10,},
        {"field": "debit_amount", "pos": 20, "len": 12,},
        {"field": "credit_amount", "pos": 32, "len": 12,},
        {"field": "company_id", "pos": 44, "len": 10,},
        {"field": "mesg_auth_code", "pos": 54, "len": 19,},
        {"field": "reserved", "pos": 73, "len": 6,},
        {"field": "orig_dfi_id", "pos": 79, "len": 8,},
        {"field": "orig_dfi_id", "pos": 87, "len": 7,},
    ]

    ENTRY_DETAIL_DEF = [
        {"field": "record_type_code", "pos": 0, "len": 1,},
        {"field": "transaction_code", "pos": 1, "len": 2,},
        {"field": "recv_dfi_id", "pos": 3, "len": 8,},
        {"field": "check_digit", "pos": 11, "len": 1,},
        {"field": "dfi_acnt_num", "pos": 12, "len": 17,},
        {"field": "amount", "pos": 29, "len": 10,},
        {"field": "ind_id", "pos": 39, "len": 15,},
        {"field": "ind_name", "pos": 54, "len": 22,},
        {"field": "disc_data", "pos": 76, "len": 2,},
        {"field": "add_rec_ind", "pos": 78, "len": 1,},
        {"field": "trace_num", "pos": 79, "len": 15,},
    ]

    ADDENDA_RECORD_DEF = [
        {"field": "record_type_code", "pos": 0, "len": 1,},
        {"field": "addenda_type_code", "pos": 1, "len": 2,},
        {"field": "pmt_rel_info", "pos": 3, "len": 80,},
            ...
            for line_num in range(start, stop):
                if self.ach_lines[line_num]:
                    ...
                    if self.ach_lines[line_num][0] == self.ADDENDA_RECORD:
                        self.ach_data["batches"][cur_batch]["entries"][cur_entry][
                            "addenda"
                        ].append(
                            self.__parse_line(
