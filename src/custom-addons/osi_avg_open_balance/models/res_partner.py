    ...
    def _cron_compute_open_invoice_average(self):
        ...
        for partner_id in partners:
            ...
            if partner_id.total_due:
                partner_id.open_invoice_total = (
                    partner_id.open_invoice_total + partner_id.total_due
                )
            partner_id.open_invoice_average = (
                partner_id.open_invoice_total / partner_id.open_invoice_days
            )
