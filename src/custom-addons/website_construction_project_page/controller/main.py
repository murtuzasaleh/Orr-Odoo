...
class WebsiteProject(http.Controller):
    ...
    def website_project(self, **kw):
        ...
        for category in category_ids:
            project_count = project_obj.search_count(
    ...
    def project_category(self, **kw):
        ...
        return request.render(
            "website_construction_project_page.project_categary", values
        )
    ...
    def project_details(self, **kw):
        ...
        return request.render(
            "website_construction_project_page.project_description_full", values
        )
