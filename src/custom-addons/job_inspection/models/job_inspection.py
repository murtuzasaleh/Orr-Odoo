...
class JobOrderInspection(models.Model):
    ...
    task_id = fields.Many2one("project.task", string="Job Order", required=True,)
    ...
    inspector_id = fields.Many2one("res.partner", string="Inspection Responsible",)
    ...
    costsheet_id = fields.Many2one("job.costing", string="Job Cost Sheet",)
    costsheet_line_id = fields.Many2one("job.cost.line", string="Job Cost Sheet Line",)
    ...
    inspection_result = fields.Many2one(
        "inspection.result", string="Inspection Result", copy=False
    )
    image1 = fields.Binary(string="Photo 1", copy=False)
    image2 = fields.Binary(string="Photo 2", copy=False)
    image3 = fields.Binary(string="Photo 3", copy=False)
    image4 = fields.Binary(string="Photo 4", copy=False)
    image5 = fields.Binary(string="Photo 5", copy=False)
    result_description = fields.Text(string="Result Description", copy=False)
    inspection_location = fields.Char(string="Inspection Location",)
    reference = fields.Char(string="Reference Specification",)
    ...
    process_by_id = fields.Many2one(
        "res.users", string="Processed By", readonly=True, copy=False,
    )
    ...
    process_date = fields.Date(string="Processed Date", readonly=True, copy=False,)
    done_date = fields.Date(string="Completed Date", readonly=True, copy=False,)
    cancel_date = fields.Date(string="Cancelled Date", readonly=True, copy=False,)
    ...
    reference_drawing = fields.Binary(string="Reference Drawing",)
